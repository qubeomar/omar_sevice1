...
from qube.src.api.swagger_models.omar_sevice1 import VersionModel
...
class omar_sevice1ItemVersionController(Resource):
    def __init__(self, *args, **kwargs):
        super(omar_sevice1ItemVersionController, self).__init__(*args, **kwargs)
        self.config = QubeConfig.get_config()

    @swagger.doc(
        {
            'tags': ['omar_sevice1'],
            'description': 'omar_sevice1 Version operation',
