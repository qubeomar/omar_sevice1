...
from qube.src.api.swagger_models.omar_sevice1 import omar_sevice1Model # noqa: ignore=I100
from qube.src.api.swagger_models.omar_sevice1 import omar_sevice1ModelPost # noqa: ignore=I100
from qube.src.api.swagger_models.omar_sevice1 import omar_sevice1ModelPostResponse # noqa: ignore=I100
from qube.src.api.swagger_models.omar_sevice1 import omar_sevice1ModelPut # noqa: ignore=I100
...
from qube.src.api.swagger_models.response_messages import (
    ...
    put_response_msgs)
from qube.src.commons.error import omar_sevice1ServiceError
...
class omar_sevice1ItemController(Resource):
    @swagger.doc(
        {
            'tags': ['omar_sevice1'],
            'description': 'omar_sevice1 get operation',
    ...
    def get(self, authcontext, entity_id):
        """gets an omar_sevice1 item that omar has changed
        """
        try:
            LOG.debug("Get details by id %s ", entity_id)
            data = omar_sevice1Service(authcontext['context'])\
                .find_by_id(entity_id)
            clean_nonserializable_attributes(data)
        except omar_sevice1ServiceError as e:
            LOG.error(e)
        ...
        return omar_sevice1Model(**data), 200

    @swagger.doc(
        {
            'tags': ['omar_sevice1'],
            'description': 'omar_sevice1 put operation',
    ...
    def put(self, authcontext, entity_id):
        """
        updates an omar_sevice1 item
        """
        try:
            model = omar_sevice1ModelPut(**request.get_json())
            context = authcontext['context']
            omar_sevice1Service(context).update(model, entity_id)
            return EMPTY, 204
        except omar_sevice1ServiceError as e:
            LOG.error(e)
            return ErrorModel(**{'error_code': str(e.errors.value),
    ...
    @swagger.doc(
        {
            'tags': ['omar_sevice1'],
            'description': 'omar_sevice1 delete operation',
    ...
    def delete(self, authcontext, entity_id):
        """
        Delete omar_sevice1 item
        """
        try:
            omar_sevice1Service(authcontext['context']).delete(entity_id)
            return EMPTY, 204
        except omar_sevice1ServiceError as e:
            LOG.error(e)
            return ErrorModel(**{'error_code': str(e.errors.value),
...
class omar_sevice1Controller(Resource):
    @swagger.doc(
        {
            'tags': ['omar_sevice1'],
            'description': 'omar_sevice1 get operation',
    ...
    def get(self, authcontext):
        """
        gets all omar_sevice1 items
        """
        LOG.debug("Serving  Get all request")
        list = omar_sevice1Service(authcontext['context']).get_all()
    ...
    @swagger.doc(
        {
            'tags': ['omar_sevice1'],
            'description': 'omar_sevice1 create operation',
    ...
    def post(self, authcontext):
        """
        Adds a omar_sevice1 item.
        """
        try:
            model = omar_sevice1ModelPost(**request.get_json())
            result = omar_sevice1Service(authcontext['context'])\
                .save(model)

            response = omar_sevice1ModelPostResponse()
