...
from qube.src.api.omar_sevice1controller import omar_sevice1Controller
from qube.src.api.omar_sevice1controller import omar_sevice1ItemController
from qube.src.api.versioncontroller import omar_sevice1ItemVersionController
...
api.add_resource(omar_sevice1ItemVersionController, '/v1/omar_sevice1/version')
api.add_resource(omar_sevice1Controller, '/v1/omar_sevice1')
api.add_resource(omar_sevice1ItemController, '/v1/omar_sevice1/<string:entity_id>')
