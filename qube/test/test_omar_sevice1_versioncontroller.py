...
HELLO_VERSION = "/v1/omar_sevice1/version"
...
class Testomar_sevice1VersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_omar_sevice1_default_version(self, *args, **kwargs):
    ...
    def test_omar_sevice1_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
